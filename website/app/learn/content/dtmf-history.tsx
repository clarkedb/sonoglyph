  ...
  return (
    <>
      ...
      <p>
        ...
        Detector engineers had a word for that failure — <strong>talk-off</strong>, a decoder
        tripped by speech — and the design that emerged is a fortress against it, three decisions
        deep.
      </p>
      <p>
      ...
      <p>
        ...
        voice, a plucked string, hold music — is a harmonic stack: energy at a fundamental and at
        its <em>integer multiples</em>. The eight DTMF frequencies were chosen to be{' '}
      ...
      <p>
        ...
        say, 770 and 1336 Hz at once — their ratio is 1.735, stubbornly non-integer, like every
        other ratio in the plan. So requiring a non-integer-related pair is voice rejection built
        out of arithmetic: no extra circuitry, just number theory hiding in the choice of eight
        numbers.
      </p>
      <p>
        The third decision covers everything arithmetic can’t. A valid digit must <em>persist</em> —
        the standards require a tone to hold for roughly 40 ms before it counts — and the two tones
        must arrive within a few dB of each other, a quantity with the delightful name{' '}
        ...
        and alone for 40 ms. Turning those per-frame matches into one clean key press — debouncing,
        gap handling — is the segmentation machinery from{' '}
