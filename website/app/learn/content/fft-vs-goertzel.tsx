  ...
  return (
    <>
      <p>
        ...
        entire frequency axis, itemized. Then you go hunting through the skyline for the two peaks
        you actually wanted. For a playground whose whole point is <em>watching</em>, that
      ...
      <p>
        ...
        Same order. Goertzel’s real economies are subtler: no windowing pass, no magnitude
      ...
      <p className="aside">
        The playground runs both decoders side by side on live audio, with a toggle, plus a
