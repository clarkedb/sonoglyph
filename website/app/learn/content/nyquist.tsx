  ...
  return (
    <>
      ...
      <p>
        ...
        <em>fs</em> can faithfully capture any frequency below <em>fs</em>/2 — a boundary called the{' '}
        <strong>Nyquist frequency</strong>, after Harry Nyquist, the Bell Labs engineer who worked
        out the limit in the 1920s (Claude Shannon proved the full theorem in 1949). At 48 kHz the
        ceiling is 24 kHz; at the 8 kHz rate telephones use, it is 4 kHz. Below the ceiling, the
        samples pin down one and only one wave. The theorem’s promise is stronger than it first
        sounds: not “a decent approximation,” but <em>perfect</em> reconstruction, in principle, of
      ...
      <p>
        ...
        ceiling and a second sine appears, dashed — the alias — and notice what the figure is{' '}
      ...
      <p className="aside">
        You have seen aliasing with your own eyes. A film camera is a sampler too — 24 frames per
        second — and a wagon wheel or helicopter rotor spinning faster than 12 revolutions per
        second folds back exactly the same way, appearing to slow, stop, or turn lazily backward on
        screen. Same theorem, different converter.
      </p>
      <p>
        ...
        analog world — by the time software could act, the folding is already in the numbers.
        (Modern converters actually sample far above the target rate and do most of the filtering
        digitally where it’s cheap and precise, but the principle is untouched: filter first, then
        commit to samples.) The figure’s play button skips this filter deliberately; your audio
        hardware never does.
      </p>
      ...
      <p>
        ...
        nowhere near the edge. DTMF’s highest tone is 1,633 Hz — a fourteenth of the ceiling. That
        is not an accident of generosity; it is inherited history. DTMF was engineered for telephone
