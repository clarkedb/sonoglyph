...
export default function PeakDetection() {
  return (
    <>
      <p>
        A spectrum is a picture. It is a very good picture — 1,025 magnitudes, one per bin, the
        whole frequency axis laid out like a skyline — but a recognizer cannot act on a skyline. It
        needs a claim:{' '}
        <em>
          there is a tone at 697.1 Hz, and another at 1209.3 Hz, and nothing else that matters
        </em>
        . Turning the picture into that short list of claims is peak detection, and it is the
        pipeline’s first act of interpretation — the first stage that throws information away on
        purpose.
      </p>
      <p>
      ...
      <p>
        ...
        23.4 Hz wide — and a real tone almost never lands on a bin center. Its energy piles up in
        the nearest bin, leaks into the neighbors, and the honest answer “the peak is in bin 30”
        means only “somewhere between 691 and 714 Hz.” That is not good enough. The DTMF recognizer
        in <a href="/learn/building-a-recognizer">chapter 07</a> checks measured frequencies against
        a ±2% tolerance — about ±14 Hz at 697 Hz — so a bin-center answer could burn most of the
      ...
      <p>
        ...
        nearly a parabola. So take the peak bin and its two neighbors — three points — fit the
