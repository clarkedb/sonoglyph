...
export default function SoundAndSampling() {
  return (
    <>
      <p>
        A telephone keypad, a Morse transmission, an alien chord: every signal this project decodes
      ...
      <p>
        Everything downstream of the converter operates on that plain list of numbers: the FFT, the
        feature streams, the recognizers, the glyphs. This is a load-bearing fact about the
      ...
      <p className="aside">
        ...
        frequency takes a hair more than two samples per cycle, so anything above ~40 kHz covers the
        whole audible band, with margin for the hardware’s filters. 44,100 (the CD rate) and 48,000
        (the film/video rate) are the two conventions that stuck; browsers and audio interfaces
        overwhelmingly run at 48 kHz today, so this pipeline does too.
      </p>
      <p>
